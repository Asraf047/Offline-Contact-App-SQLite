        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            ...
            switch (state) {
                ...
                case TelephonyManager.CALL_STATE_RINGING:
                    ...
                    Toast.makeText(MainActivitycall.this, incomingNumber + " calls you",
                ...
                case TelephonyManager.CALL_STATE_OFFHOOK:
                    ...
                    Toast.makeText(MainActivitycall.this, "on call...",
                ...
                case TelephonyManager.CALL_STATE_IDLE:
                    ...
                    if (onCall == true) {
                        ...
                        Toast.makeText(MainActivitycall.this, "restart app after call",
